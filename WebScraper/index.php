...
<body>
	...
	if (isset($_POST["element"])) {
					...
					<div class="row skills">
						...
						<div class="row">
	                        ...
	                        <div class="col-sm-6 col-sm-offset-3">
	                            ...
	                            <div class="pfblock-header wow fadeInUp">
	                                <h2 class="pfblock-title">plain text of element:</h2>
	                                <div class="pfblock-line"></div>
	                                <div class="pfblock-subtitle">
	                                    ';

	        foreach($html->find($e) as $element)
					echo $element->plaintext . '<br>';
		...
		if (isset($_POST["src"])) {
			echo '
			<section class="pfblock pfblock-gray" id="src">
					...
					<div class="row skills">
						...
						<div class="row">
	                        ...
	                        <div class="col-sm-6 col-sm-offset-3">
	                            ...
	                            <div class="pfblock-header wow fadeInUp">
	                                <h2 class="pfblock-title">src of element":</h2>
	                                <div class="pfblock-line"></div>
	                                <div class="pfblock-subtitle">
	                                    ';
